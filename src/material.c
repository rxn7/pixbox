...
const Material *material_from_id(uint8_t id) {
	...
	case ID_WATER:	return &WATER_MATERIAL;
	case ID_FIRE:	return &FIRE_MATERIAL;
	case ID_GAS:	return &GAS_MATERIAL;
	case ID_WOOD:	return &WOOD_MATERIAL;
	case ID_ACID:	return &ACID_MATERIAL;
	case ID_OIL:	return &OIL_MATERIAL;
	case ID_ICE:	return &ICE_MATERIAL;
	default:		
